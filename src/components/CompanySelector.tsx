...
const companies: Company[] = [
  { id: 'zepto', name: 'Zepto', color: 'hsl(280 70% 50%)', lightColor: 'hsl(280 60% 95%)', icon: '⚡' },
  { id: 'swiggy-instamart', name: 'Swiggy Instamart', color: 'hsl(25 95% 53%)', lightColor: 'hsl(25 90% 95%)', icon: '🛒' },
  { id: 'bigbasket', name: 'BigBasket', color: 'hsl(145 70% 40%)', lightColor: 'hsl(145 60% 95%)', icon: '🧺' },
  { id: 'flipkart-minutes', name: 'Flipkart Minutes', color: 'hsl(45 95% 50%)', lightColor: 'hsl(45 90% 95%)', icon: '📦' },
